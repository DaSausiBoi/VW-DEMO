...
function updateGMSteeringWheelImage(canData) {
    ...
    if (state === 'state1') {
        steeringWheel.style.backgroundImage = "url('pics/zone1-stw-notouch-gm.png')";
    } else if (state === 'state2') {
        steeringWheel.style.backgroundImage = "url('pics/zone1-stw-yestouch-gm.png')";
    }
}
...
setInterval(function () {
    ...
    updateGMSteeringWheelImage(wheel_canData);
