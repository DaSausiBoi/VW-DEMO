...
function updateFordSteeringWheelImage(canData) {
    ...
    if (state === 'state1') {
        steeringWheel.style.backgroundImage = "url('pics/zone1-stw-notouch-ford.png')";
    } else if (state === 'state2') {
        steeringWheel.style.backgroundImage = "url('pics/zone1-stw-yestouch-ford.png')";
    }
}
...
setInterval(function () {
    ...
    updateFordSteeringWheelImage(wheel_canData);
